...
{
    public partial class ModificarEncargadosTiendasSPLT : Form
    {
    ...
    *********************************************************************************************/
        ...
        public ModificarEncargadosTiendasSPLT()
        {
            InitializeComponent();
        ...
        private void ModificarEncargadosTiendasSPLT_MouseDown(object sender, MouseEventArgs e)
        {
       ...
       */
        ...
        /*
            --> BOTON SELECCIONAR REGISTRO A MODIFICAR ENCARGADOS DE TIENDAS SPLT 
        */
        ...
        /*
             --> BOTON MODIFICAR ENCARGADOS DE TIENDAS SPLT 
        */

        private void RegistrarEncargadoTienda_Click(object sender, EventArgs e)
        {
            if (txtidencargadotienda.Text.Length == 0 || txtcodigoUtiendas.Text.Length == 0 || txtdireccionCtiendas.Text.Length == 0 || txttelefonotiendas.Text.Length == 0)
            {
                // CREANDO MENSAJE EN VENTANA FLOTANTE PERSONALIZADO
            ...
            else
            {
                ...
                string query = "UPDATE EncargadosTiendas SET Id_empleado = @id_empleado, Nombre_empleado = @nombre_empleado, Apellido_empleado = @apellido_empleado, Codigo_tienda = @codigoTSPLT, Tefefono_tienda = @telefonoTSPLT, Direccion_tienda = @direccionTSPLT WHERE ID_encargado=@ID_encargado";
                ...
                comando.Parameters.AddWithValue("@id_empleado", txtIDEmpleadoSPLT.Text);                // ID EMPLEADO ASIGNADO ENCARGADO TIENDA
                comando.Parameters.AddWithValue("@nombre_empleado", txtNombreEmpleadoSPLT.Text);        // NOMBRE EMPLEADO ASIGNADO ENCARGADO TIENDA
                comando.Parameters.AddWithValue("@apellido_empleado", txtApellidoEmpleadoSPLT.Text);    // APELLIDO EMPLEADO ASIGNADO ENCARGADO TIENDA
                ...
                comando.Parameters.AddWithValue("@ID_encargado", txtidencargadotienda.Text);               // REFERENCIA DEL ID UNICO DE CADA TIENDA
                comando.ExecuteNonQuery(); // ENVIANDO COMPONENTE QUERY HACIA LA BASE DE DATOS CON NUEVO REGISTRO ACTUALIZADO
                // CREANDO MENSAJE EN VENTANA FLOTANTE PERSONALIZADO
                if (MessageBox.Show("Encargado de tienda modificado con éxito", "Modificando Encargados Tiendas SpeedLimit Taller Existentes",
        ...
        /*
            --> BOTON VER LISTA EMPLEADOS PERSONALIZADA 
        */
