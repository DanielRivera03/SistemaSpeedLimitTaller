...
{
    public partial class EmpleadosVendedores : Form
    {
        ...
        *********************************************************************************************/
        ...
        public EmpleadosVendedores(string nombre)
        {
            InitializeComponent();
            NombreUsuarioTUVen.Text = nombre; // DEVUELVE NOMBRE DE USUARIO REGISTRADO
      ...
      */
        ...
        */
        ...
        // MUESTRA VENTANA DE INICIO --> USUARIOS ROL {VENDEDORES / MISMO QUE ADMINISTRADORES}

        private void IconInicioRetorno_Click(object sender, EventArgs e)
        {
            // INVOCANDO FORMULARIO DE BIENVENIDA PARA USUARIOS VENDEDORES
            MostrarFormularios(new InicioAdmins());
        }
        ...
        private void btnProductos_Click(object sender, EventArgs e)
        {
            ...
            MostrarFormularios(new VistaProductosEmVendedores());
        }
        ...
        {
            // INVOCANDO FUNCION Y MOSTRANDO EXCLUSIVAMENTE FORMULARIO DE PRODUCTOS DEL SISTEMA
            MostrarFormularios(new VistaInventariosEmVendedores());
        }
        ...
        {
            // INVOCANDO FUNCION Y MOSTRANDO EXCLUSIVAMENTE FORMULARIO DE PRODUCTOS DEL SISTEMA
            MostrarFormularios(new VistaTiendasEmVendedores());
        }
        ...
        */
        ...
        private void EmpleadosVendedores_MouseDown(object sender, MouseEventArgs e)
        {
