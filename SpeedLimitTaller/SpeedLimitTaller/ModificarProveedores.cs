...
namespace SpeedLimitTaller
{
    public partial class ModificarProveedores : Form
    {
        ...
        */
        ...
        private void ModificarProveedores_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        */
        ...
        /*
            --> BOTON SELECCIONAR PROVEEDOR A EDITAR EN EL REGISTRO 
        */
        ...
        /*
            --> BOTON ACCION MODIFICAR PROVEEDORES 
        */
        ...
        private void ModificarRegistroProveedor_Click(object sender, EventArgs e)
        {
            ...
            else // SI HA SELECCIONADO UN REGISTRO, ENTONCES...
            {
                ...
                string query = "UPDATE ProveedoresProdutos SET Nombre_proveedor = @nomvbreproveedorM, Sector_Comercial = @sectorcomercialM, Direccion = @direccionM, Telefono = @telefonoM, Email = @emailM WHERE ID_proveedor=@ID_proveedor";
                ...
                comando.Parameters.AddWithValue("@nomvbreproveedorM", txtnombreproveedor.Text);             // NOMBRE PROVEEDOR
                comando.Parameters.AddWithValue("@sectorcomercialM", txtsectorcomercialproveedor.Text);     // SECTOR COMERCIAL PROVEEDOR
                comando.Parameters.AddWithValue("@direccionM", txtdireccionproveedor.Text);                 // DIRECCION PROVEEDOR
                comando.Parameters.AddWithValue("@telefonoM", txttelefonoproveedor.Text);                   // TELEFONO PROVEEDOR
                comando.Parameters.AddWithValue("@emailM", txtemailproveedor.Text);                         // EMAIL PROVEEDOR
                comando.Parameters.AddWithValue("@ID_proveedor", txtidproveedor.Text);                      // REFERENCIANDO ID PROVEEDOR A ACTUALIZAR EN EL REGISTRO
                comando.ExecuteNonQuery(); // EJECUTANDO COMANDO Y ENVIANDO DATOS HACIA LA BASE DE DATOS
                // CREANDO MENSAJE EN VENTANA FLOTANTE PERSONALIZADO
                if (MessageBox.Show("Proveedor Modificado Con Exito", "Modificando Proveedor Existente",
